                    ...
                    <div style="background-color: #292828; margin: 10px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.9);"class="wrapper">
                      ...
                      <form method="POST">
                        ...
                        <div class="form-group">
                          <label>Title</label>
                          <input style="background-color: #292828;" name="title" type="text" placeholder="Title" class="input-sm form-control" value="<?php echo $row['title']; ?>">
                        </div>
                        <div class="form-group">
                          <label>Note</label>
                          <textarea style="background-color: #292828;" name="note" class="form-control" rows="8" data-minwords="8" data-required="true" placeholder="Take a Note ......"><?php echo $row['note']; ?></textarea>
                        </div>
                        <div class="m-t-lg"><button class="button-17"class="btn btn-sm btn-default" name="update" type="submit">Update Note</button></div>
                      </form>
                    </div>
                </aside>
